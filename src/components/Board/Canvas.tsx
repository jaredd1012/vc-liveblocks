...
import LayerComponent from "../../components/LayerPanel/LayerComponent";
import SelectionTools from "../../components/LayerPanel/SelectionTools";
import useDisableScrollBounce from "../../hooks/useDisableScrollBounce";
import useDeleteLayers from "../../hooks/useDeleteLayers";
import MultiplayerGuides from "../../components/Board/MultiplayerGuides";
...
export function Canvas() {
  ...
  /**
   * Insert an item at the given position and select it
   */
  const insertLayer = useMutation(
    (
      { storage, setMyPresence },
      layerType: LayerType.Ellipse | LayerType.Rectangle | LayerType.Text | LayerType.Icon,
      position: Point
    ) => {
      ...
      const layer = new LiveObject({
        ...
        x: position.x,
        y: position.y,
        height: layerType === LayerType.Text ? 400 : 100,
        width: layerType === LayerType.Text ? 400 : 100,
        fill: lastUsedColor,
      });
